...
enum VideoAspectRatio {AR_KEEP_DEFAULT, AR_VGA, AR_3_4, AR_16_9, AR_221_100};
...
struct AVPacket {
	...
	int64_t pcr;      // last program clock reference if packet demuxed from TS container. used for VBV streaming in RTP/RTSP mode
...
public:
    ...
    ~BaseAbstractStreamReader() {}
    virtual int writeAdditionData(uint8_t* dst, uint8_t* dstEnd, AVPacket& avPacket, PriorityDataInfo* priorityData) {return 0;}
};
