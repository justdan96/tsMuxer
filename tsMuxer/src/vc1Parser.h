...
enum VC1PictType {I_TYPE, P_TYPE, B_TYPE, BI_TYPE};
...
public:
	VC1SequenceHeader(): VC1Unit(), interlace(0), time_base_num(0), time_base_den(0), m_fpsFieldBitVal(0), sample_aspect_ratio(1,1) {}
	int profile;
	int res_sm;
	int frmrtq_postproc;
	int bitrtq_postproc;
