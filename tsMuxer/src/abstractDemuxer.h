...
public:
	...
	virtual int simpleDemuxBlock ( DemuxedData& demuxedData, const PIDSet& acceptedPIDs, 
		                           int64_t& discardSize) 
	{
		discardSize = 0;
		return 0;
    ...
    virtual void setFileBlockSize ( uint32_t nFileBlockSize ) { 
		m_fileBlockSize = nFileBlockSize; 
	}
