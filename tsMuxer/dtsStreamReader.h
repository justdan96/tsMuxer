...
public:
	enum DTSHD_SUBTYPE {DTS_SUBTYPE_UNINITIALIZED, DTS_SUBTYPE_MASTER_AUDIO, DTS_SUBTYPE_HIGH_RES, DTS_SUBTYPE_EXPRESS, DTS_SUBTYPE_EX, DTS_SUBTYPE_96, DTS_SUBTYPE_OTHER};
