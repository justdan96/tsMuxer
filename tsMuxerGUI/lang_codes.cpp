...
{
    return (index.row() == COMMON_ROW_IDX || index.row() == ALL_ROW_IDX) ? Qt::NoItemFlags /* make them unselectable */
...
std::array<LangCodesModel::QtvLangCode, 502> LangCodesModel::getFullLangList()
{
    return {QtvLangCode{"ace", LangCodesModel::tr("Acehnese, Achinese")},
            ...
            QtvLangCode{"nor", LangCodesModel::tr("Norwegian")},
            QtvLangCode{"nob", LangCodesModel::tr("Norwegian Bokm?l")},
            ...
            QtvLangCode{"oci", LangCodesModel::tr("Occitan (post 1500); Proven?al")},
            ...
            QtvLangCode{"pro", LangCodesModel::tr("Proven?al, Old (to 1500)")},
            ...
            QtvLangCode{"vol", LangCodesModel::tr("Volap?k")},
